...
e|Monthly Recommended Patches
|19c (with work around)<<table1footnote,^[12]^>>
...
[[table1footnote]]^12^::
  See link:https://github.com/oravirt/ansible-oracle/issues/309[Issue 309] for more details.
