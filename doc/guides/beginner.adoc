...
.Connect using Visual Studio Code from Windows Host (skip to next example when VSCode is not used)
----
code example/beginner/vscode/beginner.code-workspace
----

.Connect into VM with SSH from `git+bash` (alternative method to VSCode)
----
